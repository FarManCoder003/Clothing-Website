...
const Arrivals2 = () => {
  return (
    <>
      <Container>
        <div className="flex flex-wrap justify-between lg:mt-[128px]">
          <div className="w-[48%] lg:w-[24%] py-5">
            ...
            <div className="flex justify-between items-center py-3">
              <h2 className="text-[#262626] font-sans text-xs lg:text-[20px] font-bold">
        ...
        <div className="font-sans  text-xl lg:text-[39px] font-bold text-[#262626] lg:mb-[48px]">
          Special Offers
        </div>
